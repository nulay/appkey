...
public class JIntellitypeTester extends JFrame implements HotkeyListener, IntellitypeListener {
    ...
    private void btnRegisterHotKey_actionPerformed(ActionEvent aEvent) {
        ...
        JIntellitype.getInstance().registerSwingHotKey(KeyEvent.VK_Z,0,KeyEvent.VK_Z);
        JIntellitype.getInstance().registerSwingHotKey(KeyEvent.VK_X,0, KeyEvent.VK_X);
        JIntellitype.getInstance().registerSwingHotKey(KeyEvent.VK_SPACE,0, KeyEvent.VK_SPACE);
        JIntellitype.getInstance().registerSwingHotKey(KeyEvent.VK_UP,0, KeyEvent.VK_UP);
        JIntellitype.getInstance().registerSwingHotKey(KeyEvent.VK_DOWN, 0, KeyEvent.VK_DOWN);
        JIntellitype.getInstance().registerSwingHotKey(KeyEvent.VK_LEFT, 0, KeyEvent.VK_LEFT);
        JIntellitype.getInstance().registerSwingHotKey(KeyEvent.VK_RIGHT, 0, KeyEvent.VK_RIGHT);
...
//        JIntellitype.getInstance().registerHotKey(TICK, 0, 192);
        // clear the text area
        textArea.setText("");
        output("RegisterHotKey VK_Z");
        output("RegisterHotKey VK_X");
        output("RegisterHotKey VK_SPACE");
        output("RegisterHotKey VK_UP");
        output("RegisterHotKey VK_DOWN");
        output("RegisterHotKey VK_LEFT");
        output("RegisterHotKey VK_RIGHT");
    }
